  ...
  return (
    <section id="experience" className="py-12 sm:py-16 border-t border-slate-800/40 relative scroll-mt-16">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="flex items-center gap-2 text-cyan-400 font-mono text-xs font-semibold uppercase tracking-wider mb-1.5">
        ...
        <div className="relative">
          ...
          <div className="hidden md:block absolute left-[140px] top-4 bottom-4 w-0.5 bg-gradient-to-b from-cyan-400 via-cyan-500/50 to-slate-800" />
          <div className="md:hidden absolute left-4 top-4 bottom-4 w-0.5 bg-gradient-to-b from-cyan-400 via-cyan-500/50 to-slate-800" />
            ...
            {resumeData.experience.map((exp, idx) => (
              ...
              >
                ...
                <div className="hidden md:flex md:w-[130px] pr-5 pt-1 flex-col items-end shrink-0 text-right space-y-2">
                  ...
                  {/* Date Range Badge */}
                  <div className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-md bg-slate-900 border border-cyan-500/30 text-cyan-400 font-mono text-[11px] font-semibold shadow-md whitespace-nowrap">
                ...
                <div className="hidden md:flex absolute left-[140px] top-5 -translate-x-1/2 z-20 items-center justify-center">
                  <div className="w-8 h-8 rounded-full bg-slate-900 border-2 border-cyan-400 shadow-lg shadow-cyan-500/30 flex items-center justify-center text-cyan-400 group-hover:scale-110 transition-transform duration-300">
                ...
                <div className="md:hidden absolute left-4 top-5 -translate-x-1/2 z-20 flex items-center justify-center">
                  <div className="w-7 h-7 rounded-full bg-slate-900 border-2 border-cyan-400 shadow-lg shadow-cyan-500/30 flex items-center justify-center text-cyan-400">
                ...
                <div className="pl-8 md:pl-8 w-full">
                  <div
                    className={`p-5 sm:p-6 rounded-xl border shadow-lg transition-all duration-300 hover:shadow-cyan-500/5 ${
                      isDarkMode
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-4 pb-4 border-b border-slate-700/40">
                      ...
                      <div className="min-w-0">
                        ...
                        <div className="md:hidden flex items-center gap-3 mb-3">
                          ...
                          <div className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-md bg-slate-900/80 border border-slate-800 text-cyan-400 font-mono text-[11px] font-semibold">
                        ...
                        <p className="text-xs sm:text-sm font-semibold text-cyan-400 mt-0.5">{exp.company}</p>
                      </div>
            ...
            <div id="education" className="scroll-mt-24 pt-4">
              <div className="relative flex items-center gap-3 pl-0 md:pl-[115px] mb-2">
                <div className="hidden md:flex absolute left-[140px] -translate-x-1/2 z-20 items-center justify-center">
                  <div className="w-6 h-6 rounded-full bg-cyan-500/20 border border-cyan-400 text-cyan-400 flex items-center justify-center">
            ...
            {resumeData.education.map((edu, idx) => {
              ...
              return (
                ...
                >
                  ...
                  {/* Timeline Dot Node on Desktop Vertical Line */}
                  <div className="hidden md:flex absolute left-[140px] top-5 -translate-x-1/2 z-20 items-center justify-center">
                    <div className="w-8 h-8 rounded-full bg-slate-900 border-2 border-emerald-400 shadow-lg shadow-emerald-500/30 flex items-center justify-center text-emerald-400 group-hover:scale-110 transition-transform duration-300">
                  ...
                  {/* Mobile Timeline Dot Node */}
                  <div className="md:hidden absolute left-4 top-5 -translate-x-1/2 z-20 flex items-center justify-center">
                    <div className="w-7 h-7 rounded-full bg-slate-900 border-2 border-emerald-400 shadow-lg shadow-emerald-500/30 flex items-center justify-center text-emerald-400">
                  ...
                  <div className="pl-8 md:pl-8 w-full">
                    ...
                    >
                      ...
                      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-4 pb-4 border-b border-slate-700/40">
                        ...
                        <p className="text-xs sm:text-sm font-semibold text-cyan-400 mt-0.5">{edu.institution}</p>
                      </div>
